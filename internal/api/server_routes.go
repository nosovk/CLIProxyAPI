...
func (s *Server) setupRoutes() {
	...
	v1.Use(s.credentialPoolMiddleware())
	{
	...
	openaiV1.Use(s.credentialPoolMiddleware())
	{
	...
	codexDirect.Use(s.credentialPoolMiddleware())
	{
	...
	v1beta.Use(s.credentialPoolMiddleware())
	{
